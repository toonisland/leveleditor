...
class LevelEditor(NodePath, DirectObject):
    ...
    def reset(self, fDeleteToplevel = 1, fCreateToplevel = 1,
        ...
        self.outputFile = None
        self.panel["title"] = 'TIA Level Editor: No file loaded'
    ...
    async def renderMapScaled(self):
        ...
        data = "This file is automatically generated by the TIA Level Editor\n" \
               "https://github.com/toonisland/leveleditor\n" \
