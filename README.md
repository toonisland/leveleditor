...
## A fork of the open sourced modernized version of Disney's in-house Toontown Online level editor used to create .dna files.
...
* Make sure the hood's storage file is loaded. You do this by adding it to the `--hoods` launch option. For example, if you want to work on a street in Rainbow Rise and another in Olive Oasis, you set the launch option `--hoods DD MM`
